...
const Confirmation: React.FC<ConfirmationProps> = ({ onDone, onHelp }) => {
  return (
    <div className="flex flex-col h-full bg-[#F8F9FA]">
      <div className="bg-blue-600 px-6 pt-12 pb-24 relative overflow-hidden flex flex-col items-center">
        <button onClick={onDone} className="absolute top-6 left-6 p-2 bg-white/20 rounded-full text-white"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg></button>
        ...
        <p className="text-white/60 font-semibold mt-2 z-10">Transaction ID: #8392192</p>
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-black/5">
          <div className="p-6 bg-white border-b-2 border-dashed border-gray-100">
             <div className="flex items-center justify-between mb-6">
               <div className="flex items-center space-x-2 text-blue-600">
                 ...
                 <span className="font-bold uppercase tracking-widest text-sm">Bus Ticket</span>
               </div>
             ...
             <div className="flex items-center justify-between">
                <div className="text-left">
                  <p className="text-[10px] font-bold text-gray-400 uppercase">LON</p>
                  <h3 className="text-3xl font-extrabold text-gray-900 mt-1">14:00</h3>
                ...
                <div className="flex-1 px-4 flex flex-col items-center">
                   ...
                   <p className="text-[10px] text-gray-400 font-bold mt-2">4h 30m</p>
                   <p className="text-[8px] text-gray-300 uppercase tracking-tighter mt-1">Express 402</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-400 uppercase">MAN</p>
                  <h3 className="text-3xl font-extrabold text-gray-900 mt-1">18:30</h3>
          ...
          <div className="p-8 bg-gray-50 grid grid-cols-2 gap-y-6">
             <div>
               ...
               <h4 className="font-bold text-gray-800 mt-1">John Doe</h4>
             </div>
             <div className="text-right">
               <p className="text-[10px] font-bold text-gray-300 uppercase">Date</p>
               <h4 className="font-bold text-gray-800 mt-1">12 Oct 2023</h4>
             </div>
             <div>
               <p className="text-[10px] font-bold text-gray-300 uppercase">Seat</p>
               <h4 className="font-bold text-gray-800 mt-1">42A <span className="text-xs text-gray-400 font-normal">(Window)</span></h4>
             </div>
             <div className="text-right">
               <p className="text-[10px] font-bold text-gray-300 uppercase">Platform</p>
               <h4 className="font-bold text-gray-800 mt-1">Gate 4</h4>
             </div>
          </div>
             ...
             <div className="p-4 border-2 border-dashed border-gray-100 rounded-2xl">
               <div className="w-32 h-32 bg-[#2D4E4E] p-2 rounded-lg flex flex-col items-center justify-center">
                  <div className="w-24 h-24 bg-white p-2 flex items-center justify-center">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=SwiftTransit-8392192" alt="QR Code" className="w-full h-full" />
                  </div>
                  <span className="text-[8px] text-white mt-1">IDL9</span>
               </div>
             </div>
